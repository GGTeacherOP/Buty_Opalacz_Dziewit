...
<head>
  ...
  <title>Sklep z Butami – Adidas Klapki Czarne</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Adidas/KlapkiCzarne/1.avif" alt="Adidas Klapki Czarne" class="main-img" />
        <div class="thumbnails">
          <img src="img/Adidas/KlapkiCzarne/1.avif" alt="Zdjęcie 1" />
          <img src="img/Adidas/KlapkiCzarne/2.avif" alt="Zdjęcie 2" />
          <img src="img/Adidas/KlapkiCzarne/3.avif" alt="Zdjęcie 3" />
          <img src="img/Adidas/KlapkiCzarne/4.avif" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Adidas Klapki Czarne</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Adidas Klapki Czarne">
    <input type="hidden" name="cena" value="179">
    <input type="hidden" name="zdjecie" value="img/Adidas/KlapkiCzarne/1.avif">
...
<script>
    ...
    <section class="opinie-produktu">
      ...
      <blockquote>⭐️⭐️⭐️⭐️ "Szybka dostawa, dotarły w idealnym stanie." – Mateusz</blockquote>
    </section>
  </main>
</div>
     <footer class="footer">
