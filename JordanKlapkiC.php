...
<head>
  ...
  <title>Sklep z Butami – Jordan Klapki Czarne</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Jordan/KlapkiCzarne/1.avif" alt="Jordan Klapki Czarne" class="main-img" />
        <div class="thumbnails">
          <img src="img/Jordan/KlapkiCzarne/1.avif" alt="Zdjęcie 1" />
          <img src="img/Jordan/KlapkiCzarne/2.avif" alt="Zdjęcie 2" />
          <img src="img/Jordan/KlapkiCzarne/3.avif" alt="Zdjęcie 3" />
          <img src="img/Jordan/KlapkiCzarne/4.avif" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Jordan Klapki Czarne</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Jordan Klapki Czarne">
    <input type="hidden" name="cena" value="250">
    <input type="hidden" name="zdjecie" value="img/Jordan/KlapkiCzarne/1.avif">
    <button type="submit" class="buy-now">Dodaj do koszyka</button>
  </form>
   <form action="zapis_zamowienia.php" method="POST">
    <input type="hidden" name="nazwa" value="Jordan Klapki Czarne">
    <input type="hidden" name="cena" value="250">
    <input type="hidden" name="zdjecie" value="img/Jordan/KlapkiCzare/1.avif">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Świetnie wyglądają, wygodne!" – Natalia</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "Szybka dostawa, dobry produkt." – Ania</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
