...
<head>
  ...
  <title>Sklep z Butami – Jordan 1 Chicago</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Jordan/J1Chicago/J1Chicago1.jpg" alt="Jordan 1 Chicago" class="main-img" />
        <div class="thumbnails">
          <img src="img/Jordan/J1Chicago/J1Chicago1.jpg" alt="Zdjęcie 1" />
          <img src="img/Jordan/J1Chicago/J1Chicago2.jpg" alt="Zdjęcie 2" />
          <img src="img/Jordan/J1Chicago/J1Chicago3.jpg" alt="Zdjęcie 3" />
          <img src="img/Jordan/J1Chicago/J1Chicago4.jpg" alt="Zdjęcie 4" />
        </div>
      </div>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Jordan 1 Chicago">
    <input type="hidden" name="cena" value="1599">
    <input type="hidden" name="zdjecie" value="img/Jordan/J1Chicago/J1Chicago1.jpg">
  ...
  <button class="buy-now">Kup teraz</button>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️ "Gorąco polecam. Wygoda i wygląd w jednym!" – Stanisław</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "Szybka dostawa, dotarły w znakomitym stanie." – Błażej</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
