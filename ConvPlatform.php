...
<head>
  ...
  <title>Sklep z Butami – Converse All Star Platform Czarny</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Converse/ConversePlatform/ConversePlatform1 (1).jpg" alt="Converse All Star Platform Czarny" class="main-img" />
        <div class="thumbnails">
          <img src="img/Converse/ConversePlatform/ConversePlatform1 (1).jpg" alt="Zdjęcie 1" />
          <img src="img/Converse/ConversePlatform/ConversePlatform1 (1).webp" alt="Zdjęcie 2" />
          <img src="img/Converse/ConversePlatform/ConversePlatform1 (2).jpg" alt="Zdjęcie 3" />
          <img src="img/Converse/ConversePlatform/ConversePlatform1 (3).jpg" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Converse All Star Platform </h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Converse All Star Platform ">
    <input type="hidden" name="cena" value="399">
    <input type="hidden" name="zdjecie" value="img/Converse/ConversePlatform/ConversePlatform1 (1).jpg">
    <button type="submit" class="buy-now">Dodaj do koszyka</button>
  </form>
    <form action="zapis_zamowienia.php" method="POST">
    <input type="hidden" name="nazwa" value="Converse All Star Platform Czarny">
    <input type="hidden" name="cena" value="399">
    <input type="hidden" name="zdjecie" value="img/Converse/ConversePlatform/ConversePlatform1 (1).jpg">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️ "Ładne buty!" – Monika</blockquote>
      <blockquote>⭐️⭐️⭐️ "Lekko opóźniona dostawa, buty dotarły w dobrym stanie." – Ewelina</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
