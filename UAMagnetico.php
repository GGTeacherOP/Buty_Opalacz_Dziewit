...
<head>
  ...
  <title>Sklep z Butami – Under Armour Magnetico</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_1.png" alt="Under Armour Magnetico" class="main-img" />
        <div class="thumbnails">
          <img src="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_1.png" alt="Zdjęcie 1" />
          <img src="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_2.png" alt="Zdjęcie 2" />
          <img src="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_3.png" alt="Zdjęcie 3" />
          <img src="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_4.png" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Under Armour Magnetico</h1>
        <p class="price">299 zł</p>
        <p>Stylowe buty treningowe</p>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Under Armour Magnetico">
    <input type="hidden" name="cena" value="299">
    <input type="hidden" name="zdjecie" value="img/UnderArmour/Magnetico/UA_Magnetico_Elite_4Fg_1.png">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️ "Wygodne buty." – Jakub</blockquote>
      <blockquote>⭐️⭐️⭐️ "Szybka dostawa, polecam." – Piotr</blockquote>
    </section>
  </main>
</div>
     <footer class="footer">
