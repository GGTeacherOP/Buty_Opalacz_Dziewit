...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Jordan/Mocha/Mocha1.jpeg" alt="Nike Air Jordan 1 Mocha" class="main-img" />
      ...
      <div class="product-details">
        <h1>Nike Air Jordan 1 High Mocha</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Nike Air Jordan 1 High Mocha">
    <input type="hidden" name="cena" value="1249">
    <input type="hidden" name="zdjecie" value="img/Jordan/Mocha/Mocha1.jpeg">
    <button type="submit" class="buy-now">Dodaj do koszyka</button>
  </form>
   <form action="zapis_zamowienia.php" method="POST">
    <input type="hidden" name="nazwa" value="Jordan 1 Mocha">
    <input type="hidden" name="cena" value="1249">
    <input type="hidden" name="zdjecie" value="img/Jordan/Mocha/Mocha1.jpeg">
