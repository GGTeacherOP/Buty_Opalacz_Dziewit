...
<head>
  ...
  <title>Sklep z Butami – Nike Klapki Białe</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Nike/KlapkiBiale/1.avif" alt="Nike Klapki Biale" class="main-img" />
        <div class="thumbnails">
          <img src="img/Nike/KlapkiBiale/1.avif" alt="Zdjęcie 1" />
          <img src="img/Nike/KlapkiBiale/2.avif" alt="Zdjęcie 2" />
          <img src="img/Nike/KlapkiBiale/3.avif" alt="Zdjęcie 3" />
          <img src="img/Nike/KlapkiBiale/4.avif" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Nike Klapki Białe</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Nike Klapki Białe">
    <input type="hidden" name="cena" value="199">
    <input type="hidden" name="zdjecie" value="img/Nike/KlapkiBiale/1.avif">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Wyglądają świetnie, wygodne klapki!" – Aleksandra</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "Dostawa przyszła troche opóźniona a tak to wszystko było dobrze" – Leon</blockquote>
    </section>
  </main>
</div>
      <footer class="footer">
