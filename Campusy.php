...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      ...
      <div class="product-details">
        <h1>Adidas Campus 00s Bezowe</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Adidas Campus 00s Bezowe">
    <input type="hidden" name="cena" value="529">
    <input type="hidden" name="zdjecie" value="img/Adidas/Campus/1.avif">
