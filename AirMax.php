...
<head>
  ...
  <title>Sklep z Butami – Nike Air Max 90</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Nike/AIR MAX/MAX1.png" alt="Nike Pegasus Premium" class="main-img" />
        <div class="thumbnails">
          <img src="img/Nike/AIR MAX/MAX1.png" alt="Zdjęcie 1" />
          <img src="img/Nike/AIR MAX/MAX2.png" alt="Zdjęcie 2" />
          <img src="img/Nike/AIR MAX/MAX3.png" alt="Zdjęcie 3" />
          <img src="img/Nike/AIR MAX/MAX4.png" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Nike Air Max 90</h1>
        <p class="price">649 zł</p>
  ...
  <input type="hidden" name="nazwa" value="Nike Air Max 90">
  <input type="hidden" name="cena" value="649">
  <input type="hidden" name="zdjecie" value="img/Nike/AIR MAX/MAX1.png">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Wyglądają świetnie, bardzo wygodne!" – Marzena</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Polecam, szybka wysyłka i super jakość." – Jakub</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
