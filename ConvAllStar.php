...
<head>
  ...
  <title>Sklep z Butami – Converse Chuck Taylor All Star</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Converse/ConverseAllStar/ConverseALLStar1.jpg" alt="Converse Chuck Taylor All Star" class="main-img" />
        <div class="thumbnails">
          <img src="img/Converse/ConverseAllStar/ConverseALLStar1.jpg" alt="Zdjęcie 1" />
          <img src="img/Converse/ConverseAllStar/ConverseAllStar2.webp" alt="Zdjęcie 2" />
          <img src="img/Converse/ConverseAllStar/ConverseALLSTAR3.webp" alt="Zdjęcie 3" />
          <img src="img/Converse/ConverseAllStar/ConverseALLSTAR4.webp" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Converse Chuck Taylor All Star</h1>
        <p class="price">349 zł</p>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Converse Chuck Taylor All Star">
    <input type="hidden" name="cena" value="349">
    <input type="hidden" name="zdjecie" value="img/Converse/ConverseAllStar/ConverseALLStar1.jpg">
