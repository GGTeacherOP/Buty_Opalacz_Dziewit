...
<head>
  ...
  <title>Sklep z Butami – Under Armour Infinite</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_1.png" alt="Under Armour Infinite" class="main-img" />
        <div class="thumbnails">
          <img src="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_1.png" alt="Zdjęcie 1" />
          <img src="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_2.png" alt="Zdjęcie 2" />
          <img src="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_3.png" alt="Zdjęcie 3" />
          <img src="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_4.png" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Under Armour Infinite</h1>
        <p class="price">699 zł</p>
        <p>Stylowe buty do biegania</p>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Under Armour Infinite">
    <input type="hidden" name="cena" value="699">
    <input type="hidden" name="zdjecie" value="img/UnderArmour/Infinite/UA_W_Infinite_Elite_2_1.png">
  ...
  <button class="buy-now">Kup teraz</button>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Wygodne buty, podeszwa idelna na długie dystanse." – Bartłomiej</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Szybka dostawa, zadowolony z zakupu." – Władysław</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
