...
<head>
  ...
  <title>Sklep z Butami – Adidas Forum Low</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Adidas/ForumBlack/Forum1.jpg" alt="Adidas Campus 00s" class="main-img" />
        <div class="thumbnails">
          <img src="img/Adidas/ForumBlack/Forum1.jpg" alt="Zdjęcie 1" />
          <img src="img/Adidas/ForumBlack/Forum2.jpg" alt="Zdjęcie 2" />
          <img src="img/Adidas/ForumBlack/Forum3.jpg" alt="Zdjęcie 3" />
          <img src="img/Adidas/ForumBlack/Forum4.jpg" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Adidas Forum Low</h1>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Adidas Forum Low">
    <input type="hidden" name="cena" value="529">
    <input type="hidden" name="zdjecie" value="img/Adidas/ForumBlack/Forum1.jpg">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Piękne! Zachęcam do zakupu!" – Ewa</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "Szybka dostawa, buty przyszły w idealnym stanie." – Mateusz</blockquote>
    </section>
  </main>
</div>
      <footer class="footer">
