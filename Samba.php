...
<head>
  ...
  <title>Sklep z Butami – Air Jordan 1 Mocha</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Adidas/Samba/samba1.jpg" alt="Adidas Samba OG" class="main-img" />
        <div class="thumbnails">
          <img src="img/Adidas/Samba/samba1.jpg" alt="Zdjęcie 1" />
          <img src="img/Adidas/Samba/samba2.jpg" alt="Zdjęcie 2" />
          <img src="img/Adidas/Samba/samba3.jpg" alt="Zdjęcie 3" />
          <img src="img/Adidas/Samba/samba4.jpg "alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Adidas Samba OG </h1>
        <p class="price">429 zł</p>
        <p>Stylowe sneakersy inspirowane kultowym modelem Travis Scott. Połączenie klasy i nowoczesności.</p>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Adidas Samba OG">
    <input type="hidden" name="cena" value="429">
    <input type="hidden" name="zdjecie" value="img/Adidas/Samba/samba1.jpg">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Wyglądają świetnie, bardzo wygodne!" – Ania</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "Polecam, szybka wysyłka i super jakość." – Kuba</blockquote>
      <blockquote>⭐️⭐️⭐️ "Super Wygodny But Polecam  – Halina</blockquote>
      <blockquote>⭐️⭐️ "Dostawa przyszla troche opoziona a tak to wszystko bylo dobrze" – Piotr</blockquote>
    </section>
  </main>
</div>
    <footer class="footer">
