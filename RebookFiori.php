...
<head>
  ...
  <title>Sklep z Butami – Rebook FIORI</title>
...
<body>
  ...
  <main class="product-page">
    <div class="product-container">
      <div class="gallery">
        <img src="img/Reebook/Reebok FIORI/Rebook FIORI1.jpg" alt="Rebook FIORI" class="main-img" />
        <div class="thumbnails">
          <img src="img/Reebook/Reebok FIORI/Rebook FIORI1.jpg" alt="Zdjęcie 1" />
          <img src="img/Reebook/Reebok FIORI/Rebook FIORI2.jpg" alt="Zdjęcie 2" />
          <img src="img/Reebook/Reebok FIORI/Rebook FIORI3.jpg" alt="Zdjęcie 3" />
          <img src="img/Reebook/Reebok FIORI/Rebook FIORI4.jpg" alt="Zdjęcie 4" />
        </div>
      </div>
      <div class="product-details">
        <h1>Rebook FIORI</h1>
        <p class="price">250 zł</p>
        <p>Stylowe buty sportowe</p>
  ...
  <form action="koszyk.php" method="POST">
    <input type="hidden" name="nazwa" value="Reebook FIORI">
    <input type="hidden" name="cena" value="250">
    <input type="hidden" name="zdjecie" value="img/Reebook/Reebok FIORI/Rebook FIORI1.jpg">
...
<script>
    ...
    <section class="opinie-produktu">
      <h2>Opinie</h2>
      <blockquote>⭐️⭐️⭐️⭐️⭐️ "Chętnie zachęcam do kupna!" – Iwona</blockquote>
      <blockquote>⭐️⭐️⭐️⭐️ "But dotarł w idealnym stanie, szybka dostawa." – Maciej</blockquote>
    </section>
  </main>
</div>
  <footer class="footer">
